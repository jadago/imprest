       ...
       <?php include('includes/sidemenu.php');?>
        ...
        <div class="page-content">
        	...
        	<div class="page-title">
                <h5><i class="fa fa-warning"></i> Stock Management</h5>
            </div>
            <!-- /page title -->
            ...
            <!-- Form validation -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading"><h6 class="panel-title">Stock in - Administration</h6></div>
                        <div class="datatable">
                            <table class="table">
                                <thead>
								<tr>
										...
										<td>&nbsp;</td>
                                        <td>&nbsp;</td>
										<td><a href="stock_add.php"><span class="label label-success">Receive Stock Items</span></a></td>
                                    </tr>
                                    <tr>
                                        <th>#</th>
										<th>Item Name</th>
                                ...
                                $counter=1;
                                $getitem = "SELECT stock_item.*, item_category.*,subcategory.*,item.* FROM stock_item  
											...
											INNER JOIN item ON stock_item.item = item.id 
